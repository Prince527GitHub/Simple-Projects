...
(function() {
    ...
    div.innerHTML = `<div class='dropdown-custom'><button class='dropbtn-custom' style="height:10px;width:10px;"></button><div class='dropdown-content-custom'><a href="${'http://9xbuddy.com/download?url=' + document.URL}">9xBuddy</a> <a href="https://www.y2mate.com/youtube/${document.URL.split('v=')[1].split("&list")[0]}">y2mate2</a> <a href="https://ytmp3x.com/${document.URL.split('?v=')[1].split("&list")[0]}">YTMP3X</a> <a href="https://yt1s.com/en?q=${document.URL}">YT1s</a></div></div>`;
